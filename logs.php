    ...
    <div id="wrapper">
      ...
      <br>
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h1><span aria-hidden="true"></span>Dashboard <small>Logs</small></h1>
                </div>
                <div class="col-md-2">
      ...
      <div class="row">
          ...
          <div class="col-md-9">
            ...
            <?php
                ...
                //$result = $DBcon->query("SELECT * FROM tbl_appointments");
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr> <th>Appointment ID</th><th>Username</th><th>Tutor</th><th>Date</th><th>Time</th><th>Focus Area</th> </tr> ";
