    ...
    <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="contact_login.php">Contact</a></li>
        ...
        <section id="content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p>Direct Contact (Phone: 876-974-7878, Toll Free: 1-888-929-7878, <br>Email: support@courser.com)</p>
                        ...
                        <form name="sentMessage" id="contactForm" novalidate>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <textarea rows="10" cols="100" class="form-control"
                                              placeholder="Type Message" id="body" required
                            ...
                            <button type="button" onclick="sendEmail()" value="Send An Email" class="btn btn-primary pull-right">Send</button><br />
                        </form>
                    </div>
                    <div class="col-md-6">
